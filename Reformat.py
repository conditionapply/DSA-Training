...
# and dashes. Then, group the digits from left to right into blocks of length 3 until there are
# 4 or fewer digits. The final digits are then grouped as follows:
